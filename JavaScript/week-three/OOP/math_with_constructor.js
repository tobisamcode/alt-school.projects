...
class MathHelper {
  constructor(num1, num2, instanceName) {
    //Code in constructor always runs before creating the instance
...
const mathHelper1 = new MathHelper(20, 10, "math1 instance");
const mathHelper2 = new MathHelper(40, 10, "math2 instance");
