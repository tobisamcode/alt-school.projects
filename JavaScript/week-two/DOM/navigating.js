...
// console.log("Previous Sibling ", document.body.previousElementSibling); // null

// // get the next sibling of the head tag
// console.log("Next Sibling: ", document.head.nextElementSibling); // null

// // Parent: parentNode
// // get the parent of the head tag
// console.log("Parent: ", document.body.parentElement); // body
